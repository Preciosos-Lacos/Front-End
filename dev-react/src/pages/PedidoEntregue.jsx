    ...
    <div className="pedido-entregue-page">
      ...
      <main>
        <div className="pedido-section container py-4">
          <div className="cards-centralizados" style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', gap: '32px', width: 'auto', margin: '0px auto' }}>            
            ...
            <div className="card produtos shadow-lg rounded-4 p-4 mb-4" style={{ background: '#fff', minWidth: 320, maxHeight: 400, flex: '1 1 320px', height: '356.37px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
